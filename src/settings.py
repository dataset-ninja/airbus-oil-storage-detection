...
##################################
PROJECT_NAME: str = "Airbus Oil Storage Detection"
...
HOMEPAGE_URL: str = "https://www.kaggle.com/datasets/airbusgeo/airbus-oil-storage-detection-dataset"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 877909
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/airbus-oil-storage-detection"
...
DOWNLOAD_ORIGINAL_URL: Optional[
    Union[str, dict]
] = "https://www.kaggle.com/datasets/airbusgeo/airbus-oil-storage-detection-dataset/download?datasetVersionNumber=1"
